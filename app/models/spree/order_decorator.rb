module Spree
  Order.class_eval do
    def product_customizations_match(line_item, new_customizations)
      matching_customizations(li.product_customizations, new_product_customizations)
    end    
    ...
    def matching_customizations(existing_customizations,new_customizations)
      ...
      return false unless existing_customizations.map(&:product_customization_type_id).sort == 
        new_customizations.map(&:product_customization_type_id).sort
